...
namespace MVVM.Editor
{
    public static class MVVMValidator
    {
        ...
        {
            var allSceneViews = Object.FindObjectsByType<MVVM.View>(FindObjectsInactive.Include, FindObjectsSortMode.None);
            var allBinders =
        ...
        private static bool IsBrokenView(MVVM.View view)
        {
        ...
        private static void MarkDependedViews(MVVM.View sourceView, MVVM.View[] allViews)
        {
        ...
        private static void MarkDependedBinders(MVVM.View sourceView, BinderBase[] allBinders)
        {
