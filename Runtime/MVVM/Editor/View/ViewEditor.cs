...
namespace MVVM.Editor.View
{
    [CustomEditor(typeof(MVVM.View))]
    public class ViewEditor : UnityEditor.Editor
    {
        ...
        {
            var oldSourceViewValue = _sourceView.objectReferenceValue as MVVM.View;
            EditorGUILayout.PropertyField(_sourceView);
            serializedObject.ApplyModifiedProperties();

            var newSourceView = _sourceView.objectReferenceValue as MVVM.View;
        ...
        {
            var sourceView = _sourceView.objectReferenceValue as MVVM.View;
        ...
        private ICollection<string> GetAllViewModelPropertyNames(MVVM.View sourceView)
        {
